...
export class InmuebleComponent {
  ...
  ColumnsTable: string [] =['title', 'address', 'department', 'city', 'description','price','latlongitude','bathrooms','bedrooms', 'closet', 'createdAt','updatedAt','createdBy','updatedBy', 'actions'];
  dataInit:   Inmueble[]=[];
